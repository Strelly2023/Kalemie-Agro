...
const translations = {
  en: {
    ...
    product_eggs_desc: "Farm-fresh eggs collected daily, rich in nutrients and ideal for households and businesses.",
    product_chicken: "🍗 Broilers",
    product_chicken_desc: "High-quality broiler chicken, hygienically processed for home or retail markets.",
    product_manure: "🌱💩 Organic Manure",
    product_manure_desc: "Natural poultry manure, eco-friendly and effective for enriching soil fertility.",
    ...
    product_juice: "🥤 Juices & Jams",
    product_juice_desc: "Delicious juices and jams made from mango, pineapple, and guava — rich in flavor and nutrients.",
...
founder_note: "🌱 From Our Founder: \"Kalemie Agro is more than a farm — it’s a movement to nourish our communities, empower our people, and protect our land for future generations.\"",
  ...
  sw: {
    ...
    products_subtitle: "Bidhaa mbichi, zenye lishe, na zinazolimwa hapa Kalemie.",
    category_poultry: "🐓 Kuku",
    product_eggs: "🥚 Mayai Mapya",
    product_eggs_desc: "Mayai ya shamba yakokusanywa kila siku, yenye lishe na bora kwa kaya na biashara.",
    product_chicken: "🍗 Kuku wa Nyama",
    product_chicken_desc: "Kuku wa nyama bora, umeandaliwa kwa usafi kwa ajili ya kaya au mauzo ya rejareja.",
    product_manure: "🌱💩 Mbolea Asili",
    product_manure_desc: "Mbolea ya asili kutoka kwa kuku, rafiki kwa mazingira na yenye ufanisi kwa udongo.",
    category_cassava: "🌿 Mihogo",
    product_flour: "🌾 Unga wa Mihogo",
    product_flour_desc: "Unga safi wa mihogo uliolimwa hapa Kalemie, kamili kwa upishi na kuoka.",
    product_chips: "🍘 Chips za Mihogo",
    product_chips_desc: "Chips za mihogo chenye kranchi na ladha nzuri, chaguo lishe kwa vitafunwa.",
    product_starch: "🧂 Stachi ya Mihogo",
    product_starch_desc: "Stachi safi ya mihogo kwa matumizi ya kaya na viwanda.",
    category_fruits: "🍊 Matunda & Juisi",
    product_fruits: "🍍 Matunda Mapya",
    product_fruits_desc: "Matunda ya ndani, yamechaguliwa kwa ubora na ladha.",
    product_juice: "🥤 Juisi & Jam",
    product_juice_desc: "Juisi na jam nzuri kutoka embe, nanasi na guava — yenye ladha na lishe.",
    category_future: "🌱 Mazao ya Baadaye",
    product_maize: "🌽 Mahindi",
    product_maize_desc: "Kilimo kipya cha mahindi ili kuongeza chakula na thamani ya kilimo.",
    product_beans: "🫘 Maharagwe",
    product_beans_desc: "Maharagwe yenye lishe, yamekuliwa hapa kusaidia usalama wa chakula.",
    product_vegetables: "🥦 Mboga",
    product_vegetables_desc: "Mboga mbichi ili kukuza lishe bora kwa jamii ya ndani.",
...
founder_note: "🌱 Kutoka kwa Mwenza Mwanzilishi: \"Kalemie Agro ni zaidi ya shamba — ni harakati ya kuchangia jamii, kuwawezesha watu, na kulinda ardhi yetu kwa vizazi vijavyo.\"",
  ...
  fr: {
    ...
    products_subtitle: "Produits agroalimentaires frais, nutritifs et locaux de Kalemie.",
    category_poultry: "🐓 Volaille",
    product_eggs: "🥚 Œufs Frais",
    product_eggs_desc: "Œufs frais de la ferme, collectés quotidiennement, riches en nutriments et parfaits pour les ménages et les entreprises.",
    product_chicken: "🍗 Poulets",
    product_chicken_desc: "Poulet de haute qualité, transformé de manière hygiénique pour la maison ou la vente au détail.",
    product_manure: "🌱💩 Engrais Organique",
    product_manure_desc: "Fumier de volaille naturel, écologique et efficace pour enrichir le sol.",
    ...
    product_chips_desc: "Chips croquantes et savoureuses, idéales comme snack sain.",
    product_starch: "🧂 Amidon de Manioc",
    product_starch_desc: "Amidon de manioc pur pour usage domestique et industriel.",
    category_fruits: "🍊 Fruits & Jus",
    product_fruits: "🍍 Fruits Frais",
    product_fruits_desc: "Fruits locaux, soigneusement sélectionnés pour leur fraîcheur, qualité et goût.",
    product_juice: "🥤 Jus & Confitures",
    product_juice_desc: "Délicieux jus et confitures à base de mangue, ananas et goyave — riches en saveur et nutriments.",
    category_future: "🌱 Cultures Futures",
    product_maize: "🌽 Maïs",
    product_maize_desc: "Culture de maïs à venir pour diversifier l'approvisionnement alimentaire.",
    product_beans: "🫘 Haricots",
    product_beans_desc: "Haricots riches en nutriments, cultivés localement pour soutenir la sécurité alimentaire.",
    product_vegetables: "🥦 Légumes",
    product_vegetables_desc: "Légumes frais pour promouvoir des régimes sains dans les communautés locales.",
